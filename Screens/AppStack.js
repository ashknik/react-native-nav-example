...
const CreateInvite = () => {
  ...
  return (
    ...
    <ScrollView showsVerticalScrollIndicator={false} horizontal={false} style={{ flex: 1, width: '100%', height: '100%' }}>
      <ScrollView horizontal={true} style={{ flex: 1, width: 350, height: 350 }}>
